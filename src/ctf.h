...
public:
     ...
     */
    void read(MetaDataTable &MD1, MetaDataTable &MD2);

    /** Just set all values explicitly */
    void setValues(double _defU, double _defV, double _defAng, double _voltage, double _Cs, double _Q0, double _Bfac);
