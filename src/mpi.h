...
public:
     ...
     */
    int relion_MPI_Send(void *buf, long int count, MPI_Datatype datatype, int dest, int tag, MPI_Comm comm);

    int relion_MPI_Recv(void *buf, long int count, MPI_Datatype datatype, int source, int tag, MPI_Comm comm, MPI_Status &status);
